...
//         FontManager fontManager = new FontManager(32*0.8f);
//         CharacterGenFactory factory = new CharacterGenFactory(1024,1024,32,32,5);
//         File saveDir = new File(System.getProperty("user.dir"), "images");
//
//         long startTime = System.currentTimeMillis();
//         for (int codepoint = 0x0000; codepoint <= 0xffff; codepoint++) {
//             while (!factory.addCharacter(codepoint, fontManager.findSuitable(codepoint))) {
//
//             }
//         }
...
//
//         int i = 0;
//         for (CharacterGenFactory.PageOperator operator : factory.pageOperators) {
//             File savePath = new File(saveDir, "page_"+i+".png");
//             CharacterImageGenerator.saveImage(operator.page.image, savePath);
//
//             i++;
//         }
//     }
