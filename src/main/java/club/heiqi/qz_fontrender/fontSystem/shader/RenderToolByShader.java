package club.heiqi.qz_fontrender.fontsystem.shader;
...
public class RenderToolByShader {
    public static Logger LOG = LogManager.getLogger();
    public static RenderToolByShader instance;

    public static RenderToolByShader getInstance() {
        if (instance == null) {
            instance = new RenderToolByShader();
        }
        return instance;
    }
